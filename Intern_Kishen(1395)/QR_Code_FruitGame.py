...
# Load assets
tree_img = load_image("tree-removebg-preview.png")
apple_img = load_image("Apple-removebg-preview.png", (30, 30))
background_img = load_image("milkyway-8190232_640.jpg", (1280, 720))
